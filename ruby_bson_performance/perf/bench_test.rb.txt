...
class BenchTest < Test::Unit::TestCase
  ...
  def test_array_index_optimization
    ...
    method_label_pairs = [
      [ method(:old_array_index),          'Array index optimize none' ],       # Xeon allocated: 3075, user: 1.6
      [ method(:new_array_index_optimize), 'Array index optimize 1024', RESET ] # Xeon allocated: 3, user: 0.7, base: 1.6, gain: 0.57
    ]
  ...
  def test_encode_bson_with_placeholder
    ...
    method_label_pairs = [
        [ method(:old_encode_bson_with_placeholder),               'Encode bson optimize to_bson' ],         # Xeon allocated: 14, user: 8.9
        [ method(:new_encode_bson_with_placeholder_to_bson_int32), 'Encode bson optimize to_bson_int32' ],   # Xeon allocated: 14, user: 7.7, base: 8.9, gain: 0.13
        [ method(:new_encode_bson_with_placeholder_set_int32),     'Encode bson optimize set_int32', RESET ] # Xeon allocated: 11, user: 6.5, base: 8.9, gain: 0.26
    ]
  ...
  def test_integer_to_bson_optimization
    ...
    method_label_pairs = [
      [ method(:old_integer_to_bson), 'Integer to_bson optimize none' ],             # Xeon allocated: 6151, user: 4.2
      [ method(:new_integer_to_bson), 'Integer to_bson optimize test order', RESET ] # Xeon allocated: 4101, user: 3.4, base: 4.2, gain: 0.18
    ]
  ...
  def test_bson_int32?
    method_label_pairs = [
        [ method(:old_integer_bson_int32?),     'Integer#bson_int32? old', RESET ], # Xeon allocated: 0, user: 21.3
        [ method(:new_integer_bson_int32?), 'Integer#bson_int32? new' ]             # Xeon allocated: 0, user: 24.9, base: 21.3, gain: -0.16
    ]
